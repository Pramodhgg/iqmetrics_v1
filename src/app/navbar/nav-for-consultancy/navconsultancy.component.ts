...
@Component({
  selector: 'app-navbar-for-consultancy',
  templateUrl: './navconsultancy.component.html',
  styleUrls: ['./navconsultancy.component.css']
})
export class NavForConsultancyComponent implements OnInit {
  white_nav = false;
  navDetailss = false;
